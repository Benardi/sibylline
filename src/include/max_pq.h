 ...
 *
 * @param array Array of ExtendedItems containing heap elements.
 * @return ExtendedItem containing maximum value in max-heap.
 */
 ...
 */
bool heap_increase_key(ExtendedItem array[], int i, union Key,
                       int (*compare)(union Key, union Key));
 ...
 * @return Void.
 */
void max_heap_insert(ExtendedItem array[], union Key, int* heap_size,
                     int (*compare)(union Key, union Key));
