...
typedef struct
{
  Register A[MAX]; /* Array that stores the elements */
 ...
 *  as a pointer to 0.
 *
 *  @param pointer to Sequential List to be initialized
 *  @return Void
 */
 ...
 *
 *  @param pointer to Sequential List to be reinitialized
 *  @return Void
 */
 ...
 *
 *  @param pointer to Sequential List 
