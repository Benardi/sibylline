...
START_TEST(test_list_insert_1)
{
  ...
  node1 = (DoublyLinkedList*) malloc(sizeof(DoublyLinkedList*));
...
START_TEST(test_list_insert_2)
{
  ...
  head = (DoublyLinkedList**) malloc(sizeof(DoublyLinkedList**)); 
  node1 = (DoublyLinkedList*) malloc(sizeof(DoublyLinkedList*));
  node2 = (DoublyLinkedList*) malloc(sizeof(DoublyLinkedList*));
...
START_TEST(test_list_insert_3)
{
  ...
  node1 = (DoublyLinkedList*) malloc(sizeof(DoublyLinkedList*));
  node2 = (DoublyLinkedList*) malloc(sizeof(DoublyLinkedList*));
  node3 = (DoublyLinkedList*) malloc(sizeof(DoublyLinkedList*));
  node4 = (DoublyLinkedList*) malloc(sizeof(DoublyLinkedList*));
  head = (DoublyLinkedList**) malloc(sizeof(DoublyLinkedList**));
...
START_TEST(test_list_search_1)
{
  ...
  retrieved = (DoublyLinkedList*) malloc(sizeof(DoublyLinkedList*));
  head = (DoublyLinkedList**) malloc(sizeof(DoublyLinkedList**));
