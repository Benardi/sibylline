...
static int compare_int(int k1, int k2)
{
  int result;
...
static int compare_int_impl(int k1, int k2)
{
  int result;
...
START_TEST(test_dll_get_nth_1)
{
  ...
  *head = NULL;
  ...
  ck_assert_int_eq(retrieved->data.key, 30);
  ck_assert_int_eq(retrieved->next->data.key, -67);
  ck_assert_int_eq(retrieved->next->prev->data.key, 30);
...
START_TEST(test_dll_get_nth_2)
{
  ...
  *head = NULL;
  ...
  ck_assert_int_eq(retrieved->next == NULL, true);
  ck_assert_int_eq(retrieved->prev == NULL, false);
  ck_assert_int_eq(retrieved->prev->next->data.key, -67);
...
START_TEST(test_dll_get_nth_6)
{
  ...
  *head = NULL;
  ...
  ck_assert_int_eq(retrieved->prev == NULL, false);
  ck_assert_int_eq(retrieved->next == NULL, true);
  ck_assert_int_eq(retrieved->prev->data.key, 75);
  ck_assert_int_eq(retrieved->prev->prev->data.key, 150);
...
START_TEST(test_dll_get_nth_7)
{
  ...
  *head = NULL;
  ...
  ck_assert_int_eq((*head)->data.key, 150211);
  ck_assert_int_eq((*head)->prev == NULL, true);
  ck_assert_int_eq((*head)->next == NULL, false);
  ck_assert_int_eq((*head)->next->data.key, 75123);
  ck_assert_int_eq((*head)->next->next->data.key, 257);
  ...
  ck_assert_int_eq((*head)->prev == NULL, true);
  ck_assert_int_eq((*head)->next == NULL, false);
  ck_assert_int_eq((*head)->next->data.key, 257);

  retrieved = dll_get_nth(head, 1);

  ck_assert_int_eq(retrieved->data.key, 257);
  ck_assert_int_eq(retrieved->prev == NULL, false);
  ck_assert_int_eq(retrieved->next == NULL, true);
  ck_assert_int_eq(retrieved->prev->data.key, 150211);
...
START_TEST(test_dll_get_by_idx_7)
{
  ...
  *head = NULL;
  ...
  ck_assert_int_eq((*head)->next == NULL, false);
  ck_assert_int_eq((*head)->next->data.key, 12);
  ck_assert_int_eq((*head)->next->next->data.key, 150);
  ck_assert_int_eq((*head)->next->next->next->data.key, 75);
  ck_assert_int_eq((*head)->next->next->next->next->data.key, 25);

  ck_assert_int_eq(node5->data.key, 34);
  ck_assert_int_eq(node5->prev == NULL, true);
  ck_assert_int_eq(node5->next == NULL, false);
  ck_assert_int_eq(node5->next->data.key, 12);
  ck_assert_int_eq(node5->next->next->data.key, 150);
  ck_assert_int_eq(node5->next->next->next->data.key, 75);
  ck_assert_int_eq(node5->next->next->next->next->data.key, 25);

  ck_assert_int_eq(node4->data.key, 12);
  ck_assert_int_eq(node4->prev == NULL, false);
  ck_assert_int_eq(node4->next == NULL, false);
  ck_assert_int_eq(node4->prev->data.key, 34);
  ck_assert_int_eq(node4->next->data.key, 150);
  ck_assert_int_eq(node4->next->next->data.key, 75);

  ck_assert_int_eq(node3->data.key, 150);
  ck_assert_int_eq(node3->prev == NULL, false);
  ck_assert_int_eq(node3->next == NULL, false);
  ck_assert_int_eq(node3->prev->prev->data.key, 34);
  ck_assert_int_eq(node3->prev->data.key, 12);
  ck_assert_int_eq(node3->next->data.key, 75);
  ck_assert_int_eq(node3->next->next->data.key, 25);
  ...
  ck_assert_int_eq(node2->prev == NULL, false);
  ck_assert_int_eq(node2->next == NULL, false);
  ck_assert_int_eq(node2->prev->prev->prev->data.key, 34);
  ck_assert_int_eq(node2->prev->prev->data.key, 12);
  ck_assert_int_eq(node2->prev->data.key, 150);
  ck_assert_int_eq(node2->next->data.key, 25);
  ...
  ck_assert_int_eq(node1->prev == NULL, false);
  ck_assert_int_eq(node1->next == NULL, true);
  ck_assert_int_eq(node1->prev->prev->prev->prev->data.key, 34);
  ck_assert_int_eq(node1->prev->prev->prev->data.key, 12);
  ck_assert_int_eq(node1->prev->prev->data.key, 150);
  ck_assert_int_eq(node1->prev->data.key, 75);

  retrieved = dll_get_by_idx(node3, 2, 0);

  ck_assert_int_eq(retrieved->data.key, 34);
  ck_assert_int_eq(retrieved->prev == NULL, true);
  ck_assert_int_eq(retrieved->next == NULL, false);
  ck_assert_int_eq(retrieved->next->data.key, 12);
  ck_assert_int_eq(retrieved->next->next->data.key, 150);
  ck_assert_int_eq(retrieved->next->next->next->data.key, 75);
  ck_assert_int_eq(retrieved->next->next->next->next->data.key, 25);
...
START_TEST(test_dll_get_by_idx_8)
{
  ...
  *head = NULL;
  ...
  ck_assert_int_eq(retrieved->prev == NULL, false);
  ck_assert_int_eq(retrieved->next == NULL, true);
  ck_assert_int_eq(retrieved->prev->prev->prev->prev->data.key, 34);
  ck_assert_int_eq(retrieved->prev->prev->prev->data.key, 12);
  ck_assert_int_eq(retrieved->prev->prev->data.key, 150);
  ck_assert_int_eq(retrieved->prev->data.key, 75);
