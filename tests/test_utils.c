...
START_TEST(test_swap_reg_1)
{
  ...
  ck_assert_int_eq(array[4].key.i, 1);
...
START_TEST(test_swap_reg_5)
{
  ...
  ck_assert_int_eq(array[5].key.i, 0);
...
START_TEST(test_swap_reg_6)
{
  ...
  ck_assert_int_eq(array[0].key.i, 5);
  ck_assert_int_eq(array[1].key.i, -10);
...
START_TEST(test_swap_reg_7)
{
  ...
  ck_assert_int_eq(array[2].key.i, 25);
  ck_assert_int_eq(array[3].key.i, -67);
  ck_assert_int_eq(array[4].key.i, 245);
  ck_assert_int_eq(array[5].key.i, -535);
  ck_assert_int_eq(array[6].key.i, 0);
  ck_assert_int_eq(array[7].key.i, -33);
  ck_assert_int_eq(array[8].key.i, 200);
  ck_assert_int_eq(array[9].key.i, 300);
  ck_assert_int_eq(array[10].key.i, -20);
