...
START_TEST(test_insert_sorted_2)
{
    ...
    reg->key = 7;
    result2 = insert_sorted(sl, *reg);

    reg->key = -8;
    result1 = insert_sorted(sl, *reg);
